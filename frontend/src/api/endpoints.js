...
export const claimsApi = {
  ...
  // Fetched as a blob (not a plain URL) because the endpoint requires a JWT -
  // a raw <a href> navigation never sends the Authorization header, only the
  // axios interceptor does. See components/ReceiptLink.jsx.
  attachment: (id) => client.get(`/api/claims/${id}/attachment`, { responseType: 'blob' }),
