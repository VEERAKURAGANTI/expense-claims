...
export const claimsApi = {
  ...
  edit: (id, body) =>
    client.put(`/api/claims/${id}`, body),

  discard: (id) =>
    client.delete(`/api/claims/${id}`),

  submit: (id, confirmNotDuplicate) =>
    client.post(`/api/claims/${id}/submit`, {
      confirmNotDuplicate,
    }),
};
...
export const managerApi = {
  queue: () =>
    client.get('/api/manager/queue'),

  approve: (id) =>
    client.post(`/api/manager/claims/${id}/approve`),

  reject: (id, note) =>
    client.post(`/api/manager/claims/${id}/reject`, { note }),
};
...
export const financeApi = {
  ...
  pay: (id, overrideNote) =>
    client.post(`/api/finance/claims/${id}/pay`, { overrideNote }),

  report: (month) =>
    client.get('/api/finance/report', {
      params: month ? { month } : {},
    }),
};
