...
export default function ClaimReviewPage() {
  ...
  async function handleSave(e) {
    ...
    if (!form.expenseDate) {
      setError('Please enter the date on the receipt.');
      return;
    }
  ...
  // Automatically save the latest changes before sending to manager
  async function handleSubmit() {
    ...
    try {
      // STEP 1: Automatically save the latest form values
      await claimsApi.edit(id, {
        merchant: form.merchant,
        amount,
        category: form.category,
      ...
      // STEP 2: Send the saved claim to the manager
      ...
      <div className="card">
        ...
        <div className="actions-row">
          <button
            ...
            disabled={saving}
          >
            {saving ? 'Saving & sending...' : 'Send to my manager'}
          </button>
